...
VkFormat GetVulkanFormat(UHTextureFormat InUHFormat)
{
	...
	if (FormatCache.size() == 0)
	{
		...
		FormatCache[UH_FORMAT_A2B10G10R10] = VK_FORMAT_A2B10G10R10_UNORM_PACK32;
		FormatCache[UH_FORMAT_A2R10G10B10] = VK_FORMAT_A2R10G10B10_UNORM_PACK32;
		...
		FormatCache[UH_FORMAT_R11G11B10] = VK_FORMAT_B10G11R11_UFLOAT_PACK32;
		FormatCache[UH_FORMAT_R32F] = VK_FORMAT_R32_SFLOAT;
