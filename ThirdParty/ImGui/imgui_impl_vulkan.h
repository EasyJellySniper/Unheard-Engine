...
struct ImGui_ImplVulkan_InitInfo
{
    ...
    // BEGIN UHE MOD - store the swap chain format and color space
...
IMGUI_IMPL_API void         ImGui_ImplVulkan_RenderDrawData(ImDrawData* draw_data, VkCommandBuffer command_buffer, VkPipeline pipeline = nullptr);
