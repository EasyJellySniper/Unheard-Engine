...
namespace ImGui
{
    ...
    // BEGIN UHE MOD - Add InputChar() function
    IMGUI_API bool InputChar(const char* label, char* Result);
    // END UHE MOD
    ...
    IMGUI_API void              UpdatePlatformWindows(bool bForceDestroy = false);              // call in main loop. will call CreateWindow/ResizeWindow/etc. platform functions for each secondary viewport, and DestroyWindow for each inactive viewport.
    // END UHE MOD
