...
public:
	...
	void ImportRawFbx(std::vector<UHMaterial>& InMatVector);
...
private:
	// create UH meshes
	void CreateUHMeshes(FbxNode* InNode, std::filesystem::path InPath, std::vector<UHMaterial>& InMatVector, UHRawMeshAssetCache& Cache);
