...
void UHEditor::OnEditorUpdate()
{
    ...
    UHGPUTimeQueryScope::ClearRegisteredGPUTime();
}
...
void UHEditor::SelectDebugViewModeMenu(int32_t WmId)
{
    const std::vector<int32_t> ViewModeMenuIDs = { ID_VIEWMODE_FULLLIT
        ...
        , ID_RTSHADOWS_SOFTSHADOW0
        , ID_RTSHADOWS_SOFTSHADOW1
        , ID_RTSHADOWS_SOFTSHADOW2
        , ID_RTSHADOWS_SOFTSHADOW3
        , ID_RTSHADOWS_SOFTSHADOW4
        , ID_RTSHADOWS_SOFTSHADOW5
